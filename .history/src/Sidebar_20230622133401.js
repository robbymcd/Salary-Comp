...
export default function Sidebar( { onFormSubmit } ) {
    ...
    const city1ChangeHandler = (event) => {
        setCity1(event.target.nvalue)
    }

    const city2ChangeHandler = (event) => {
        setCity2(event.target.nvalue);
    }


    const salary1ChangeHandler = (event) => {
        const inputValue = event.target.nvalue;      
                ...
                <form className='form' onSubmit={onFormSubmit}>
                    ...
                    <div className='city'>
                        ...
                        <div className="select-main">
                            <select ref={selectRef1} nvalue={city1} className='select-input' onChange={city1ChangeHandler}>
                                <option nvalue='0'>Select a City</option>
                                <option nvalue='89.1'>Abilene, TX</option>
                                <option nvalue='90.5'>Adrian, MI</option>
                                <option nvalue='89.4'>Akron, OH</option>
                                <option nvalue='85.8'>Alamogordo, NM</option>
                                <option nvalue='87.3'>Albany, GA</option>
                                <option nvalue='105.4'>Albany, OR</option>
                                <option nvalue='100.1'>Albany, NY</option>
                                <option nvalue='90.9'>Albertville, AL</option>
                                <option nvalue='92.9'>Albuquerque, NM</option>
                                <option nvalue='86.2'>Alexandria, LA</option>
                                <option nvalue='98.9'>Allentown, PA</option>
                                <option nvalue='90.8'>Altoona, PA</option>
                                <option nvalue='88.2'>Amarillo, TX</option>
                                <option nvalue='91.5'>Ames, IA</option>
