                    ...
                    <div className='city'>
                        ...
                        <div className="select-main">
                            <select ref={selectRef1} value={city1Label} className='select-input' onChange={city1ChangeHandler}>
                                ...
                                <option value='106.6' label=''>Austin, TX</option>
                                <option value='102.9' label=''>Bakersfield, CA</option>
                                <option value='107' label=''>Baltimore, MD</option>
                                <option value='98' label=''>Bangor, ME</option>
                                <option value='122.4' label=''>Barnstable Town, MA</option>
                                <option value='91.1' label=''>Baton Rouge, LA</option>
                                <option value='85.9' label=''>Battle Creek, MI</option>
                                <option value='85.4' label=''>Bay City, MI</option>
                                <option value='88.6' label=''>Beaumount, TX</option>
                                <option value='92.9' label=''>Beaver Dam, WI</option>
                                <option value='80' label=''>Beckley, WV</option>
                                <option value='111.6' label=''>Bellingham, WA</option>
                                <option value='115.9' label=''>Bend, OR</option>
                                <option value='95.7' label=''>Billings, MT</option>
                                <option value='93.3' label=''>Binghamton, NY</option>
                                <option value='90.7' label=''>Birmingham, AL</option>
                                ...
                                <option value='115' label=''>Bremerton, WA</option>
                                <option value='87.8' label=''>Brownsville, TX</option>
                                <option value='94.4' label=''>Brunswick, GA</option>
                                <option value='97.3' label=''>Buffalo, NY</option>
                                <option value='91.8' label=''>Burlington, NC</option>
                                <option value='112.8' label=''>Burlington, VT</option>
                                <option value='88.2' label=''>Canton, OH</option>
                                <option value='88.1' label=''>Cape Girardeau, MO</option>
                                <option value='83.5' label=''>Carbondale, IL</option>
                                <option value='103' label=''>Carson City, NV</option>
                                <option value='94.2' label=''>Casper, WY</option>
                                <option value='88.1' label=''>Cedar Rapids, IA</option>
                                <option value='103.3' label=''>Centralia, WA</option>
                                <option value='95.7' label=''>Chambersburg, PA</option>
                                <option value='89' label=''>Champaign, IL</option>
                                <option value='83.9' label=''>Charleston, WV</option>
                                <option value='101.7' label=''>Charleston, SC</option>
                                <option value='97.9' label=''>Charlotte, NC</option>
                                <option value='102.1' label=''>Charlottesville, VA</option>
                                <option value='91.2' label=''>Chattanooga, TN</option>
                                <option value='96.9' label=''>Cheyenne, WY</option>
                                <option value='100.1' label=''>Chicago, IL</option>
                                <option value='110.5' label=''>Chico, CA</option>
                                <option value='89.8' label=''>Chillicothe, OH</option>
                                <option value='92.4' label=''>Cincinnati, OH</option>
                                <option value='102.3' label=''>Claremont, NH</option>
                                <option value='83.4' label=''>Clarksburg, WV</option>
                                <option value='88.7' label=''>Clarksville, TN</option>
                                <option value='108.8' label=''>Clearlake, CA</option>
                                <option value='89.5' label=''>Cleveland, TN</option>
                                <option value='90' label=''>Cleveland, OH</option>
                                <option value='103.3' label=''>Coeur d'Alene, ID</option>
                                <option value='92.3' label=''>College Station, TX</option>
                                <option value='102.2' label=''>Colorado Springs, CO</option>
                                <option value='89.8' label=''>Columbia, MO</option>
                                <option value='91.9' label=''>Columbia, SC</option>
                                <option value='88.5' label=''>Columbus, GA</option>
                                <option value='89.1' label=''>Columbus, IN</option>
                                <option value='93.9' label=''>Columbus, OH</option>
                                <option value='108.3' label=''>Concord, NH</option>
